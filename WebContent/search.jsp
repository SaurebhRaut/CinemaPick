...
<body>
	...
	<div id="search_div" class="container" style="width: 500px">
		<form name="search_form" method="get" action="advsearch">
			<table align="center" class="table table-striped">
				<tbody>
					<tr>
						<td style="width: 200px">
							<div class="field_container" style="width: 115px">Title:</div>
						</td>
					...
					<tr>
						<td>
							<div class="field_container">Year:</div>
						</td>
					...
					<tr>
						<td>
							<div class="field_container">Director:</div>
						</td>
						<td><input type="text" name="director" size="50"
							maxlength="100" style="width: 230px;"></td>
					</tr>
					<tr>
						<td>
							<div class="field_container">Star's First Name:</div>
						</td>
					...
					<tr>
						<td>
							<div class="field_container">Star's Last Name:</div>
						</td>
					...
					<div class="container">
						<div class="btn-group"
							...
							<tr>
								<td align="center"><button class="btn btn-primary" type="submit" >Submit</button>
								</td>
								<td align="center"><button class="btn btn-primary" type="reset">Reset</button>
								</td>
							</tr>
						</div>
					</div>
